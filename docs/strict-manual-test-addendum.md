...
1. `GitHub Release / VSIX` の公開画面または配布準備画面で、説明文、スクリーンショット、配布物の対応が分かること。
2. `VS Code extension + key catalog` の主画面で、error と warning の違いが迷わず分かること。
...
- 実ホストアプリ上での UI 操作確認。
- GitHub Release / VSIX の審査画面または掲載画面での最終確認。
